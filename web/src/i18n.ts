...
export const i18n = createI18n({
  ...
  messages: {
    en: {
      ...
      home: {
        tagline: 'The Wikipedia Route Finder · Since 2013',
      ...
      about: {
        ...
        first:
          'There are millions of pages on Wikipedia. Do you hear about it is possible to arrive from any page to any page within 6 clicks?',
        second: ' of Wikipedia.',
