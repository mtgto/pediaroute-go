<template>
  <div class="field">
    ...
    <input class="input" v-bind="$attrs" @focus="onFocus" @blur="onBlur" @keydown="onKeydown" />
...
const showDropdown = computed(() => {
  ...
  const v = String(attrs.value ?? '');
  return !props.suggestions.some((s) => s.toLowerCase() === v.toLowerCase());
});
